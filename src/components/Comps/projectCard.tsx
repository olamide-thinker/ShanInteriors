...
// console.log('ort',orient)
  ...
  return (
    <div className=" w-[350px] border  sm:w-[400px]  relative  group"
    ...
    >
        ...
        <div className='h-full w-full top-0 absolute -z-20 flex justify-center items-center'>
        ...
        width={1000}
        height={1000}
        className={`w-full object-cover p-1 top-0 h-full   
        ${hovering && 'opacity-55'}`}
        />

        <div className='absolute  bg-black h-[97%] w-[99%] top-2 -z-10'></div>
        </div>
        ...
        className='flex flex-col justify-center items-center absolute bottom-5  mb-[16px] w-full '>
